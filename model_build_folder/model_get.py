...
def load_model():
    ...
    base_model = AutoModelForCausalLM.from_pretrained(model_name,
                                                  device_map=args.device_map,             # GPU와 CPU를 자동 분배
                                                  torch_dtype=args.torch_dtype,            # 자동으로 적절한 데이터 타입(FP32, FP16 등) 선택
                                                  offload_folder=args.offload_folder,    # 메모리가 부족할 경우 CPU로 데이터를 오프로드
